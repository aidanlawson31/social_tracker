...
class SocialMediaTest < ApplicationSystemTestCase
  ...
  test "creating a Social medium" do
    ...
    fill_in "Company", with: @social_medium.company_id
    fill_in "Description", with: @social_medium.description
    fill_in "Name", with: @social_medium.name
    fill_in "Social website", with: @social_medium.social_website
