...
class SocialMediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social_medium" do
    assert_difference('SocialMedium.count') do
      post social_media_url, params: { social_medium: { company_id: @social_medium.company_id, description: @social_medium.description, name: @social_medium.name, social_website: @social_medium.social_website } }
    end
  ...
  test "should update social_medium" do
    patch social_medium_url(@social_medium), params: { social_medium: { company_id: @social_medium.company_id, description: @social_medium.description, name: @social_medium.name, social_website: @social_medium.social_website } }
